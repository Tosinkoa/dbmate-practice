...
--
-- Name: sessions; Type: TABLE; Schema: hidden; Owner: -
--
...
CREATE TABLE public.post (
    ...
    updateed_at timestamp with time zone NOT NULL
);
...
--
-- Name: sessions sessions_pkey; Type: CONSTRAINT; Schema: hidden; Owner: -
--

ALTER TABLE ONLY hidden.sessions
